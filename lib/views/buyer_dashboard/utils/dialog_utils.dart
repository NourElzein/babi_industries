        ...
        content: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children: [
                Chip(label: const Text('ABC Corp'), backgroundColor: AppColors.kPrimaryColor.withOpacity(0.1)),
                Chip(label: const Text('Office supplies'), backgroundColor: AppColors.kSecondaryColor.withOpacity(0.1)),
                Chip(label: const Text('ORD-2020'), backgroundColor: AppColors.kAccentColor.withOpacity(0.1)),
              ],
            ),
          ],
        ),
      ...
      AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: AppColors.kErrorColor),
